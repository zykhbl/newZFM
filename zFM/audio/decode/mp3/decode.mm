...
void III_hufman_decode(struct audio_data_buf*buf, long int is[SBLIMIT][SSLIMIT], struct III_side_info*si, int ch, int gr, int part2_start, struct frame *fr_ps) {
    int i, x, y;
    int v, w;
...
void III_dequantize_sample(long int is[SBLIMIT][SSLIMIT], double xr[SBLIMIT][SSLIMIT], III_scalefac_t *scalefac, struct gr_info_s *gr_info, int ch, struct frame *fr_ps) {
...
void III_reorder(double xr[SBLIMIT][SSLIMIT], double ro[SBLIMIT][SSLIMIT], struct gr_info_s *gr_info, struct frame *fr_ps) {
...
void III_stereo(double xr[2][SBLIMIT][SSLIMIT], double lr[2][SBLIMIT][SSLIMIT], III_scalefac_t *scalefac, struct gr_info_s *gr_info, struct frame *fr_ps) {
    int sfreq = fr_ps->header.sampling_frequency;
...
void III_antialias(double xr[SBLIMIT][SSLIMIT], double hybridIn[SBLIMIT][SSLIMIT], struct gr_info_s *gr_info, struct frame *fr_ps) {
    static int    init = 1;
...
void III_hybrid(double fsIn[SSLIMIT], double tsOut[SSLIMIT], int sb, int ch, struct gr_info_s *gr_info, struct frame *fr_ps) {
    int ss;
    double rawout[36];
